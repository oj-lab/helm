...
Common labels
*/}}
{{- define "oj-lab.labels" -}}
helm.sh/chart: {{ include "oj-lab.chart" . }}
{{ include "oj-lab.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "oj-lab.selectorLabels" -}}
app.kubernetes.io/name: {{ include "oj-lab.name" . }}
